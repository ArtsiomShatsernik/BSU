...
// }
// class Ticket {
	// constructor(id, description, createdAt, author, date, time, start, finish) {
		// this.id = id
		// this.description = description
		// this.createdAt = createdAt
		// this.author = author
		// this.Route = new Route(start, finish)
...
// for(var i = 0; i < tickets.length; i++) {
	// nextObj = new Ticket(tickets[i].id, tickets[i].description, tickets[i].createdAt,
	// tickets[i].dateAndTime.date, tickets[i].dateAndTime.time,
	// tickets[i].author, tickets[i].route.start, tickets[i].route.finish
	// )
	// TicketsCollection.push(nextObj)
// }
// for(var i = 0; i < TicketsCollection.length; i++) {
	// TicketsCollection[i].get()
// }
